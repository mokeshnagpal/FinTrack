...
async function refreshAnalytics() {
  ...
  try {
    ...
    updateSummary({});
    renderEntries([]);
    setStatus('Balance analytics failed to load. Try again after the server responds.', 'danger');
    elements.insightsArea.innerHTML = '<p>Balance analytics need current server data.</p>';
  } finally {
